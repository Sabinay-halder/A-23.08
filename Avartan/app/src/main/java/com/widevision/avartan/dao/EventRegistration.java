 ...
 */
public class EventRegistration extends QueryManager<GsonClass> {
    String subeventId, data;

    public EventRegistration(String subeventId, String data) {
    ...
    protected Request.Builder buildRequest() {
        RequestBody formBody = new FormEncodingBuilder().add("tag", "event_registration").add("subeventId", subeventId).add("field_data", data)
                .build();
