 ...
 */
public class SponserDao  extends QueryManager<GsonClass> {
    String sponser_list;
    public SponserDao(String sponser_list) {

        this.sponser_list = sponser_list;


    }
    @Override
    protected Request.Builder buildRequest() {
        RequestBody formBody = new FormEncodingBuilder().add("tag", "sponser_list")
                .build();
