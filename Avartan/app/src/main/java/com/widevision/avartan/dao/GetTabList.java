 ...
 */
public class GetTabList extends QueryManager<GsonClass> {
    String subeventId;

    public GetTabList(String subeventId) {
    ...
    protected Request.Builder buildRequest() {
        RequestBody formBody = new FormEncodingBuilder().add("tag", "get_tab").add("subeventId", subeventId)
                .build();
