 ...
 */
public class RegistrationTeam extends QueryManager<GsonClass> {

    String subeventId, teamName, captianEmail, collegeName, membersEmail;

    public RegistrationTeam(String subeventId, String teamName, String captianEmail, String collegeName, String membersEmail) {
